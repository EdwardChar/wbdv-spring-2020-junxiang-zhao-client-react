...
export const TOPICS_API_URL = "https://wbdv-generic-server.herokuapp.com/api/001057049/topics"
...
export const LESSONS_TOPICS_API_URL = (lessonId) => `https://wbdv-generic-server.herokuapp.com/api/001057049/lessons/${lessonId}/topics`